    ...
    jQuery.validator.addMethod('filesize', function(value, element, maxSize) {
        ...
        if( maxSize ){
            ...
            switch( maxSize.charAt(maxSize.length - 2).toLowerCase() ){
                case 'k'    :
                    maxSize                         = formsPlus.toNumber(maxSize.slice(0, maxSize.length - 2)) * 1000;
                    break;
                case 'm'    :
                    maxSize                         = formsPlus.toNumber(maxSize.slice(0, maxSize.length - 2)) * 1000000;
                    break;
                case 'g'    :
                    maxSize                         = formsPlus.toNumber(maxSize.slice(0, maxSize.length - 2)) * 1000000000;
                    break;
                default     :
